...
return [
  ...
  // @see https://github.com/laravel-ja/laravel/blob/master/app/lang/ja/validation.php
  /*
   |--------------------------------------------------------------------------
   | バリデーション言語行
   |--------------------------------------------------------------------------
   ...
   | メッセージですサイズルールのようにいくつかのバリデーションを
   | 持っているものもありますメッセージはご自由に調整してください
   |
   */
  ...
  /*
   ...
   | メッセージを定義できます指定した属性ルールに対する特定の
   | カスタム言語行を手早く指定できます
   |
   */

  "hiragana"             => ":attributeには、ひらがなのみご利用できます",
  "katakana"             => ":attributeには、カタカナのみご利用できます",
  "hirakata"             => ":attributeには、ひらがな、カタカナがご利用できます",
  "em"                   => ":attributeには、ひらがな、カタカナ、漢字がご利用できます",
  'custom' => [
    'attribute-name' => [
  ...
  /*
   ...
   | 言語行ですこれはメッセージをよりきれいに表示するために役に立ちます
   |
   */
